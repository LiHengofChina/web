...
/*** 非公共组件 */
import DetailsSection from '@/views/workstation/approval/bottom_menu/my_approvals/pending/lease/beforehand_approval/DetailsSection.vue';
                ...
                this.$confirm(
                    ...
                    '提示',
                    {
                        ...
                        await this.$store.dispatch('approval_common_store/doCommit', {
                            targetNodeId: this.$store.getters['approval_common_store/nodeId'],
