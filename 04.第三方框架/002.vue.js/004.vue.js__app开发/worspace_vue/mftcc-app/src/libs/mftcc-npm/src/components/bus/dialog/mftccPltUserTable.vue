    ...
    watch: {
      show() {
        ...
        if (this.visible === true) {
          ...
          } else if (this.doption.isAllCorp) {
            this.$set(this.initData, "url", "/"+$servers.sys+"/sys/sysUser/findAllByPage");
          }
          ...
          if (this.doption.initSearchData) {
            this.initSearchData = this.doption.initSearchData;
            this.initSearchData.brNo = this.brNo;
            this.initSearchData.children = this.children;
            this.initSearchData.roleNo = this.roleNo;
            this.initSearchData.isAllCorp = this.doption.isAllCorp;
          } else {
            this.initSearchData = {
              brNo: this.brNo,
              children: this.children,
              roleNo: this.roleNo,
              isAllCorp: this.doption.isAllCorp
            };
          }
          this.tableShow = true;
        } else {
